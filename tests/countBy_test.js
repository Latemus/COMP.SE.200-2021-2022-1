...
test(`When input is array or object is [{'a': 1}, {'a': 2}, {'a': 2}, {'a': 2}, {'a': 3}, {'a': 3}] and iteratee (value) => value.a`, () => {
   ...
   expect(JSON.stringify(countBy(inputArrayOrObject, value => value.active))).toBe(JSON.stringify(result));
});
test(`When input is array or object is [{'a': 1}, {'a': 2}, {'a': 2}, {'a': 2}, {'a': 3}, {'a': 3}] and iteratee (value) => value.a`, () => {
   let inputArrayOrObject = [{'a': 1}, {'a': 2}, {'a': 2}, {'a': 2}, {'a': 3}, {'a': 3}]
   let result = {1: 1, 2: 3, 3: 2}
   expect(JSON.stringify(countBy(inputArrayOrObject, value => value.a))).toBe(JSON.stringify(result));
});
